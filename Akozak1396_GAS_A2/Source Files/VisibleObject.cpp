...
*  DESCRIPTION   :
*    The functions in this file are used to define the functionality of the VisibleObject class which
*	 has teh job of determining if objects are touching each other. 
*/
